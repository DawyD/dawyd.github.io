...
<div>
    <div class="split left">
        <div>
        <img id="pp" width="250" src="imgs/david.png" />
        </div>
    </div>
...
<tr><td  style="padding-right:10px">
    <img id="pub_p_small" src="imgs/teaser_spnext.png" />
    </td>
    <td>
        <p><h3>A Spatio-Photometric Neural Architecture for Photometric Stereo with Rendering in the Training Loop</h3></p>
        <p></p>
...
<tr><td  style="padding-right:10px">
    <img id="pub_p_small" src="imgs/teaser_mapdenoiser.png" />
    </td>
    <td>
        <p><h3>Image Restoration using Plug-and-Play CNN MAP Denoisers</h3></p>
...
<tr><td  style="padding-right:10px">
    <img id="pub_p_small" src="imgs/teaser_blindspot.png" />
    </td>
    <td>
        <p><h3>Efficient Blind-Spot Neural Network Architecture for Image Denoising</h3></p>
        <p><a href="https://arxiv.org/abs/2008.11010">[Paper]</a> <a href="https://github.com/DawyD/Blind-spot-CNNs">[Code]</a> </p>
...
<tr><td  style="padding-right:10px">
    <img id="pub_p_small" src="imgs/teaser_bm3d.png" />
    </td>
    <td>
        <p><h3>Accelerating Block-Matching and 3D Filtering Method for Image Denoising on GPUs</h3></p>
...
<tr><td  style="padding-right:10px">
    <img id="pub_p_small" src="imgs/teaser_sewer.jpg" />
    </td>
    <td>
        <p><h3>Detecting Defects in Sewers</h3></p>
...
<tr><td  style="padding-right:10px">
    <img id="pub_p_small" src="imgs/teaser_vivaldi.png" />
    </td>
    <td>
        <p><h3>VIVALDI: steel billet tracking with advanced computer vision</h3></p>
...
<tr><td  style="padding-right:10px">
    <img id="pub_p_small" src="imgs/hat.png" />
    </td>
    <td>
        <p><h3>Aggregating Spatial and Photometric Context for Photometric Stereo</h3></p>
        <p><a href="https://infoscience.epfl.ch/record/307334?v=pdf">[PhD Thesis]</a></p>
        <p>Topics: <span class="greenlabel">Photometric Stereo</span></p>
...
<tr><td  style="padding-right:10px">
    ...
    <td>
        <p><h3>Generative neural networks in image reconstruction</h3></p>
        <p><a href="https://dodo.is.cuni.cz/handle/20.500.11956/94721">[MSc Thesis]</a></p>
        <p>Topics: <span class="bluelabel">Image Restoration</span></p>
...
<tr><td  style="padding-right:10px">
    ...
    <td>
        <p><h3>GPU Acceleration of Advanced Image Denoising</h3></p>
        <p><a href="https://dodo.is.cuni.cz/handle/20.500.11956/82511">[BSc Thesis]</a></p>
        <p>Topics: <span class="bluelabel">Image Restoration</span></p>
